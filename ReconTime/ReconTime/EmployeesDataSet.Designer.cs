...
namespace ReconTime {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmployeeID, string FirstName, string LastName, int Active) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public int Active {
                get {
                    return ((int)(this[this.tableEmployees.ActiveColumn]));
                }
                set {
...
namespace ReconTime.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([" +
                "FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Ac" +
                "tive] = @Original_Active))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmployeeID], [FirstName], [LastName], [Active]) V" +
                "ALUES (@EmployeeID, @FirstName, @LastName, @Active);\r\nSELECT EmployeeID, FirstNa" +
                "me, LastName, Active FROM Employees WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [EmployeeID] = @EmployeeID, [FirstName] = @FirstName, [LastName] = @LastName, [Active] = @Active WHERE (([EmployeeID] = @Original_EmployeeID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Active] = @Original_Active));
SELECT EmployeeID, FirstName, LastName, Active FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FirstName, LastName, Active FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_FirstName, string Original_LastName, int Original_Active) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_Active));
        ...
        public virtual int Insert(int EmployeeID, string FirstName, string LastName, int Active) {
        ...
        public virtual int Update(int EmployeeID, string FirstName, string LastName, int Active, int Original_EmployeeID, string Original_FirstName, string Original_LastName, int Original_Active) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_Active));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, int Active, int Original_EmployeeID, string Original_FirstName, string Original_LastName, int Original_Active) {
            return this.Update(Original_EmployeeID, FirstName, LastName, Active, Original_EmployeeID, Original_FirstName, Original_LastName, Original_Active);
        }
    }
